...
public class OrderDB {
	...
	String order_date;
	int ticket_totalnum;
	double ticket_price_all;

	String cancel_flag;
	String resign_flag;
	String return_flag;

	String print_eticket_flag;
	String pay_flag;
	String pay_resign_flag;
	String confirm_flag;

	List<Ticket> tickets;

	String reserve_flag_query;
	String if_show_resigning_info;
	String recordCount;
	String isNeedSendMailAndMsg;

	List<String> array_passser_name_page;
	List<String> from_station_name_page;
	List<String> to_station_name_page;

	String start_train_date_page;
	String start_time_page;
	String arrive_time_page;
	String train_code_page;
	String ticket_total_price_page;
