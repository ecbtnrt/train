...
public class Ticket {
	...
	String ticket_status_code;
	String ticket_status_name;
	String cancel_flag;
	int amount_char;
	String trade_mode;
	String start_train_date_page;
	String str_ticket_price_page;
	String come_go_traveller_ticket_page;
	String return_deliver_flag;
	String deliver_fee_char;
	String is_need_alert_flag;
	String is_deliver;
	...
	public String getIs_need_alert_flag() {
		return is_need_alert_flag;
	}

	public void setIs_need_alert_flag(String is_need_alert_flag) {
